          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              <Button
                  size="lg"
                  variant="outline"
                  className="border-gray-400 text-gray-200 hover:bg-white hover:text-black transition-colors duration-300 text-lg px-8 py-4"
                  onClick={() => window.location.href = "https://forms.gle/thwNDRPUwadii9do7"}
              >
                Learn More
              </Button>
            ...
            <div className="text-gray-400 text-sm">
              Starting at <span className="text-2xl font-bold text-green-400">$99</span> • Available Q2 2026
            </div>
          </div>
        </div>
      </section>
